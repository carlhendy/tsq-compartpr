...
export default function Page() {
  ...
  return (
    ...
    <main className="min-h-screen relative" style={{ backgroundColor: '#151B3C' }}>
      ...
      {/* Results */}
      {hasCompared && (
        <section ref={resultsTableRef} className="mx-auto max-w-6xl px-6 pt-16 pb-12">
          ...
          <div className="pt-4 flex flex-col sm:flex-row justify-center gap-3">
            <button
              onClick={copyResults}
              className="inline-flex items-center justify-center gap-2 px-6 py-3 text-white border-2 rounded-lg text-base font-semibold transition-all duration-200 tracking-wide w-full sm:w-auto"
              style={{ fontFamily: 'Manrope, sans-serif', backgroundColor: '#2e5ce5', borderColor: '#2e5ce5' }}
