              ...
              <table className="min-w-[1200px] w-full table-fixed text-left">
                <thead className="text-sm text-slate-600" style={{ backgroundColor: '#fef9c3b3' }}>
                  <tr className="[&>th]:px-4 [&>th]:py-3">
                    ...
                    <th className="w-[11%] text-center">Competitive pricing</th>
                    <th className="w-[11%] text-center">Website quality</th>
                    <th className="w-[11%] text-center">Wallets</th>
                    <th className="w-[5%] text-center">Rating</th>
                    <th className="w-[5%] text-center">Reviews</th>
                  </tr>
                </thead>
