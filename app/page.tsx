...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-4 sm:pt-8 pb-16 px-6" style={{ backgroundColor: '#0a4bf1' }}>
      ...
      {/* Footer */}
      <footer className="border-t border-black py-16 px-4 sm:px-6 text-center text-white" style={{ backgroundColor: '#0a4bf1' }}>
